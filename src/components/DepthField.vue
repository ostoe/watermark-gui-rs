...
const isShowComputedResult = ref(true);
...
<template>
    ...
    <el-form :model="form" label-width="120px">
        ...
        <el-form-item>
            <el-col :span="11">
                <span>拍摄距离</span>
                <el-input v-model="form.object_distance" />
            </el-col>
            <el-col :span="2" class="text-center">
                <!-- <span class="text-gray-500">-</span> -->
            </el-col>
    ...
    <!-- <div v-else> -->
    <el-descriptions v-if="isShowComputedResult" title="计算结果" direction="vertical" :column="3"
        size="default" border>
